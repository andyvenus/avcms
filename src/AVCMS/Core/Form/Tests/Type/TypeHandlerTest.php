...
class TypeHandlerTest extends \PHPUnit_Framework_TestCase {
    ...
    /**
     * @var \AVCMS\Core\Form\Type\DefaultType (Mock)
     */
    private $mock_type;
    ...
    public function setUp()
    {
        ...
        $this->mock_type = $this->getMock('AVCMS\Core\Form\Type\TypeInterface');
    }

    public function testGetType()
    {
        $default_type = $this->type_handler->getType('non-existant');
        $this->assertInstanceOf('AVCMS\Core\Form\Type\DefaultType', $default_type);

        $checkbox_type = $this->type_handler->getType('checkbox');
        $this->assertInstanceOf('AVCMS\Core\Form\Type\CheckboxType', $checkbox_type);
    }
    ...
    public function testAddType()
    {
        ...
        $this->assertNotInstanceOf('AVCMS\Core\Form\Type\DefaultType', $this->type_handler->getType('mock_type'));
    }
    ...
    public function testMakeView()
    {
        ...
        $mock_form_handler = $this->getMockBuilder('AVCMS\Core\Form\FormHandler')
    ...
    private function createMockTypeWithMockMethod($method, $response)
    {
        ...
        $stub = $this->getMock('AVCMS\Core\Form\Type\TypeInterface');
