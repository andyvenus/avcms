...
use AVCMS\Users\Exception\IncorrectLoginException;
...
class ActiveUser implements EventSubscriberInterface {
    ...
    /**
     * @var \AVCMS\Core\Model\Model|\AVCMS\Users\Model\Users
     */
    ...
    {
        $login_handler = new LoginHandler($this->request, $this->users_model, $this->sessions_model);
